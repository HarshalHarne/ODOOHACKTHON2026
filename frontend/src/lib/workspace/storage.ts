...
const emptyWorkspace: WorkspaceData = {
  ...
  resources: [
    { id: "res-1", name: "Conference Room A (Boardroom)" },
    { id: "res-2", name: "Huddle Room 1" },
    { id: "res-3", name: "4K Laser Projector" },
    { id: "res-4", name: "Company Vehicle - Toyota Prius" },
  ],
  bookings: [
    { id: "book-1", resourceId: "res-1", title: "Weekly Engineering Sync", date: new Date().toISOString().split("T")[0], startHour: 10, startMinute: 0, endHour: 11, endMinute: 30, status: "confirmed" },
    { id: "book-2", resourceId: "res-3", title: "Design Review Presentation", date: new Date().toISOString().split("T")[0], startHour: 14, startMinute: 0, endHour: 15, endMinute: 0, status: "confirmed" },
  ],
  maintenanceRequests: [
  ...
  auditCycles: [
    { id: "audit-1", title: "Q1 2024 Inventory Check", departmentId: "dept-1", scopeType: "department", scopeValue: "dept-1", startDate: "2024-03-01", endDate: "2024-03-31", auditors: "Sarah Chen, Marcus Rivera", status: "open", createdAt: "2024-03-01T08:00:00Z" },
    { id: "audit-2", title: "2023 EOY Audit", departmentId: "dept-3", scopeType: "department", scopeValue: "dept-3", startDate: "2023-12-01", endDate: "2023-12-15", auditors: "David Kim", status: "closed", createdAt: "2023-12-01T08:00:00Z", closedAt: "2023-12-15T17:00:00Z" },
  ],
  auditChecklist: [
    { id: "chk-1", auditCycleId: "audit-1", assetId: "ast-1", expectedLocation: "New York Office", verification: "verified", note: "Asset present and verified" },
    { id: "chk-2", auditCycleId: "audit-1", assetId: "ast-2", expectedLocation: "New York Office", verification: "pending", note: "Awaiting recheck" },
    { id: "chk-3", auditCycleId: "audit-1", assetId: "ast-5", expectedLocation: "London Office", verification: "missing", note: "Location mismatch reported" },
  ],
  discrepancyReports: [
